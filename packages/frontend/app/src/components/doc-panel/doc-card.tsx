  ...
  return (
    ...
    >
      ...
      <div className="rounded-md bg-white/70 dark:bg-gray-900/30 p-3 border border-blue-100 dark:border-blue-800/50">
        {isLoading ? (
          <div className="text-gray-500 text-xs">{t("Loading preview...")}</div>
        ) : (
      ...
      {/* Bottom hint */}
      <div className="mt-3 text-xs text-blue-600/70 dark:text-blue-400/70">{t("📄 Click to open in side panel")}</div>
    </div>
  );
}
